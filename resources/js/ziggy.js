const Ziggy = {
    ...
    routes: {
        ...
        'companies.index': { uri: 'companies', methods: ['GET', 'HEAD'] },
        'companies.create': {
            uri: 'companies\/create',
            methods: ['GET', 'HEAD'],
        },
        'companies.store': { uri: 'companies', methods: ['POST'] },
        'companies.show': {
        ...
        'bank-accounts.store': { uri: 'bank-accounts', methods: ['POST'] },
        'bank-accounts.show': {
        ...
        'bank-accounts.edit': {
            uri: 'bank-accounts\/{bank_account}\/edit',
            methods: ['GET', 'HEAD'],
            parameters: ['bank_account'],
        },
        ...
        'delivery-notes.print': {
            uri: 'delivery-notes\/{delivery_note}\/print',
            methods: ['GET', 'HEAD'],
            parameters: ['delivery_note'],
        },
        'delivery-notes.showJson': {
            uri: 'delivery-notes\/{delivery_note}\/json',
            methods: ['GET', 'HEAD'],
            parameters: ['delivery_note'],
        },
        ...
        'delivery-notes.create': {
            uri: 'delivery-notes\/create',
            methods: ['GET', 'HEAD'],
        },
        'delivery-notes.store': { uri: 'delivery-notes', methods: ['POST'] },
        'delivery-notes.edit': {
            uri: 'delivery-notes\/{delivery_note}\/edit',
            methods: ['GET', 'HEAD'],
            parameters: ['delivery_note'],
        },
        'delivery-notes.update': {
            uri: 'delivery-notes\/{delivery_note}',
            methods: ['PUT', 'PATCH'],
            parameters: ['delivery_note'],
        },
        ...
        'laporan.delivery-notes': {
            uri: 'laporan\/delivery-notes',
            methods: ['GET', 'HEAD'],
        },
        'laporan.invoices': {
            uri: 'laporan\/invoices',
            methods: ['GET', 'HEAD'],
        },
        'documentation.index': {
            uri: 'documentation',
        ...
        'settings.update': { uri: 'settings', methods: ['PUT'] },
