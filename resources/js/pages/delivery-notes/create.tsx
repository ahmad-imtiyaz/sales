...
import type { ProductOption } from './_form';
...
export default function DeliveryNotesCreate(props: Props) {
    return (
        <>
            <Head title="Tambah Delivery Note" />
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Isi informasi DN dan daftar barang.
                        </p>
                    </div>
                </div>
                <DeliveryNoteForm {...props} mode="create" />
            </div>
        </>
    );
}

DeliveryNotesCreate.layout = {
    breadcrumbs: [
        { title: 'Transaksi', href: '#' },
        { title: 'Delivery Note', href: deliveryNotesRoutes.index.url() },
        { title: 'Tambah', href: deliveryNotesRoutes.create.url() },
    ],
};
