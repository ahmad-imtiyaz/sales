                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Perbarui DN {props.deliveryNote.nomor_dn}.
                        </p>
                    </div>
                </div>
                <DeliveryNoteForm {...props} mode="edit" />
            </div>
        </>
    );
}

DeliveryNotesEdit.layout = (props: Props) => ({
    breadcrumbs: [
        { title: 'Transaksi', href: '#' },
        { title: 'Delivery Note', href: deliveryNotesRoutes.index.url() },
        {
            title: 'Edit',
            href: deliveryNotesRoutes.edit.url(props.deliveryNote.id!),
        },
    ],
});
