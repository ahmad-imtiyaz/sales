...
DeliveryNotesEdit.layout = (props: Props) => ({ breadcrumbs: [{ title: 'Transaksi', href: '#' }, { title: 'Delivery Note', href: deliveryNotesRoutes.index.url() }, { title: 'Edit', href: deliveryNotesRoutes.edit(props.deliveryNote.id!).url() }] });
